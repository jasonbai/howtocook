...
**选择比搜索更重要** — 通过智能推荐和交互式问题收集，帮助用户快速找到合适的菜谱，而不是在海量数据中迷失。

**细节决定成败** — 提供详尽的步骤说明和实用小贴士，确保烹饪成功。

**平衡是关键** — 菜单规划注重荤素搭配、营养均衡和肉类多样性。

**简单开始，逐步提升** — 从简单菜谱开始，让新手建立信心，逐步挑战更高难度。

**实用至上** — 所有菜谱都是家常菜，使用常见食材和调料，易于实现。
